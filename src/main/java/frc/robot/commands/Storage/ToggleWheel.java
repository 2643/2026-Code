...
public class ToggleWheel extends Command {
  boolean finish;
  Phase phase;

  public ToggleWheel(Phase phase) {
  ...
  public void end(boolean interrupted) {
    ...
    switch (RobotContainer.m_Storage.getWheel()){
      case ON -> RobotContainer.m_Storage.setWheel(Wheel.OFF);
      case OFF -> RobotContainer.m_Storage.setWheel(Wheel.ON);
    }

    switch (phase) {
      case ATTACK -> RobotContainer.m_Storage.moveWheel(Constants.StorageConstants.attackSpeed);
